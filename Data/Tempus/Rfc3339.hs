...
renderRfc3339ByteString        :: (Monad m, Date t, Time t, Epoch t, LocalOffset t) => t -> m BS.ByteString
renderRfc3339ByteString t
  = renderRfc3339LazyByteString t >>= return . BSL.toStrict

renderRfc3339LazyByteString    :: (Monad m, Date t, Time t, Epoch t, LocalOffset t) => t -> m BSL.ByteString
renderRfc3339LazyByteString t
  = rfc3339Builder t              >>= return . B.toLazyByteString

renderRfc3339Text              :: (Monad m, Date t, Time t, Epoch t, LocalOffset t) => t -> m T.Text
renderRfc3339Text t
  = renderRfc3339ByteString     t >>= return . T.decodeUtf8

renderRfc3339LazyText          :: (Monad m, Date t, Time t, Epoch t, LocalOffset t) => t -> m TL.Text
renderRfc3339LazyText         t
  = renderRfc3339LazyByteString t >>= return . TL.decodeUtf8

renderRfc3339String            :: (Monad m, Date t, Time t, Epoch t, LocalOffset t) => t -> m String
renderRfc3339String t
  = renderRfc3339Text           t >>= return . T.unpack

parseRfc3339ByteString         :: (Monad m, Date t, Time t, Epoch t, LocalOffset t) => BS.ByteString  -> m t
...
parseRfc3339LazyByteString     :: (Monad m, Date t, Time t, Epoch t, LocalOffset t) => BSL.ByteString -> m t
parseRfc3339LazyByteString s
  = parseRfc3339ByteString      (BSL.toStrict s)

parseRfc3339Text               :: (Monad m, Date t, Time t, Epoch t, LocalOffset t) => T.Text         -> m t
parseRfc3339Text s
  = parseRfc3339ByteString      (T.encodeUtf8 s)

parseRfc3339LazyText           :: (Monad m, Date t, Time t, Epoch t, LocalOffset t) => TL.Text        -> m t
parseRfc3339LazyText s
  = parseRfc3339LazyByteString (TL.encodeUtf8 s)

parseRfc3339String             :: (Monad m, Date t, Time t, Epoch t, LocalOffset t) => String         -> m t
